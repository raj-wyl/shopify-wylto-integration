...
/**
 * Webhook: shop/redact
 * GDPR compliance: Shop uninstalls app and requests data deletion
 * Forwards to Wylto backend to handle shop data deletion
 */
export const action = async ({ request }) => {
  try {
    ...
    console.log(`[Webhook] Shop redact request:`, payload);
