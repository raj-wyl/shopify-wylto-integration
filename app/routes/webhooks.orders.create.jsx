...
export const action = async ({ request }) => {
  try {
    ...
    console.log(`[Webhook] [TEMP-COD] Financial Status: ${payload.financial_status || 'N/A'}, Gateway: ${payload.gateway || 'N/A'}, Payment Gateway Names: ${JSON.stringify(payload.payment_gateway_names || [])}`);
